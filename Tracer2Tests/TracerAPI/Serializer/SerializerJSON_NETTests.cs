...
{
    [TestClass()]
    public class SerializerJSON_NETTests
    {
        [TestMethod()]
        public void SerializeTest()
        {
            string expexted = System.IO.File.ReadAllText(@"D:\Projects\C#\Tracer2\TestJSON.txt");
            ...
            SerializerJSON_NET ser = SerializerJSON_NET.GetInstance();
